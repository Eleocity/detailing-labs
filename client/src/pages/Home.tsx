...
export default function Home() {
  ...
  const { data: placesStats } = trpc.reviews.getPlacesStats.useQuery(undefined, {
    ...
    <div className="min-h-screen bg-background text-foreground">
              ...
              <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-3 sm:gap-6 pt-2">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="ml-1 text-sm text-muted-foreground">
                    {placesStats?.displayText || hero.trust_reviews || "5.0 · Google Reviews"}
                  </span>
                </div>
        ...
        <div className="container py-5 sm:py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              { value: placesStats ? `${placesStats.rating}★` : "5.0★", label: placesStats?.count ? `${placesStats.count} Google Reviews` : "Google Rating" },
      ...
      <section className="py-20 sm:py-32">
        <div className="container">
          ...
          <div className="text-center">
            <a
              href="https://detailinglabswi.com/review"
              target="_blank"
            ...
            >
              ...
              {placesStats?.count
                ? `${placesStats.count} reviews · ${placesStats.rating} average on Google`
