...
const pillars = [
  ...
  },
  {
    ...
    desc: "Forma Auto Spa is small by design. You get the same trained technicians on every job — the same people who built this business and stand behind every result.",
  },
  {
...
const PACKAGE_META: Record<string, { bestFor: string; duration: string }> =
  Object.fromEntries(
    CENTRAL_PACKAGES.map(p => [
      p.name,
      {
        bestFor: p.recommendedFor,
        duration: `~${Math.round(p.durationMinutes / 60)} hours`,
      },
    ])
  );
...
const faqs = [
  ...
  },
  {
    ...
    a: "Exterior or interior alone is about 2 hours. Full Showroom Reset is 3–4 hours. The Signature Detail runs 6–8 hours. We'll give you a time window when you book.",
  },
  {
  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        {/* Labels */}
        <div className="absolute top-3 left-3 bg-black/60 text-white text-[10px] font-bold px-2 py-1 rounded-md backdrop-blur-sm">
          BEFORE
        </div>
        <div className="absolute top-3 right-3 bg-primary/80 text-white text-[10px] font-bold px-2 py-1 rounded-md backdrop-blur-sm">
          AFTER
        </div>
      </div>
      <div className="mt-3">
            ...
            >
              <motion.div variants={fadeUp}>
                <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-semibold tracking-widest uppercase">
                  ...
                  {hero.badge ||
                    "Mobile Detailing · Racine & Kenosha County, WI"}
                </span>
              </motion.div>
      ...
      <section className="border-y border-border bg-[oklch(0.10_0.005_75)]">
        <div className="container py-5 sm:py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              {
                value: about.vehicles_detailed || "150+",
                label: "Vehicles Detailed",
              },
              { value: "5.0★", label: "Google Rating" },
              {
                value: about.years_experience || "3+",
                label: "Years in SE Wisconsin",
              },
      ...
      <section className="py-20 sm:py-32">
        <div className="container">
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              className="text-muted-foreground mt-4 max-w-xl mx-auto text-sm leading-relaxed"
            >
              Every photo is from an actual Forma Auto Spa appointment in
              Southeast Wisconsin. Drag the slider to compare.
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 sm:py-32 bg-[oklch(0.06_0.002_75)]">
        <div className="container">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            variants={stagger}
            className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto mb-14"
          >
            {[
              {
                n: "01",
          ...
          >
            <Link href={BRAND.booking.primaryPath}>
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/85 text-primary-foreground font-bold px-10 h-14 text-lg shadow-xl shadow-primary/30"
              >
      ...
      <section className="py-20 sm:py-32">
        <div className="container">
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              className="text-muted-foreground mt-4 max-w-xl mx-auto text-sm"
            >
              Transparent pricing. No surprises at checkout. Prices vary by
              vehicle size — see exact pricing on the pricing page.
            </motion.p>
          </motion.div>
          ...
          >
            {(packages.length > 0
              ? packages
              : CENTRAL_PACKAGES.filter(
                  p => p.bookingEligible && p.isActive
                ).map((p, i) => ({
                  id: i + 1,
                  name: p.name,
              ...
              return (
                <motion.div key={pkg.id} variants={fadeUp}>
                  <Link href="/pricing?tab=detailing">
                    <div
                      className={`group relative flex flex-col gap-4 p-7 rounded-2xl border-2 bg-card hover:bg-primary/4 transition-all cursor-pointer h-full ${pkg.isPopular ? "border-primary/60 shadow-lg shadow-primary/10" : "border-border hover:border-primary/50"}`}
                    >
                      {pkg.isPopular && (
        ...
        <div className="container">
          ...
          >
            ...
            <motion.p
              ...
              className="text-muted-foreground mt-4 max-w-xl mx-auto text-sm leading-relaxed"
            >
              Long-term paint protection and correction work, quoted to your
              vehicle's actual condition — not a flat rate.
            </motion.p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeUp}>
              <Link href="/ceramic-coatings">
                <div className="group h-full flex flex-col gap-4 p-8 rounded-2xl border-2 border-border bg-card hover:border-primary/50 hover:bg-primary/4 transition-all cursor-pointer">
              ...
              <Link href="/paint-correction">
                <div className="group h-full flex flex-col gap-4 p-8 rounded-2xl border-2 border-border bg-card hover:border-primary/50 hover:bg-primary/4 transition-all cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed">
                      Swirl marks, light scratches, and oxidation removed by
                      hand, machine-polished to the finish level your paint can
                      support.
                    </p>
                  </div>
                  <div className="flex items-center gap-1.5 text-sm font-semibold text-primary mt-auto">
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              <motion.div
                variants={fadeUp}
                className="p-7 rounded-2xl border-2 border-primary/50 bg-primary/8 shadow-xl shadow-primary/15"
              >
                ...
                <Link href="/pricing">
                  <Button
                    variant="outline"
                    className="w-full border-border hover:border-primary/50 font-medium"
                  >
              ...
              <motion.div
                variants={fadeUp}
                className="p-5 rounded-2xl border border-border bg-card flex items-center gap-4"
              >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed mt-0.5">
                    If you're not happy with the result, tell us and we'll come
                    back and make it right — no charge.
                  </p>
                </div>
              </motion.div>
            </motion.div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 p-7 rounded-2xl border border-primary/30 bg-primary/6">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Same-week availability on most dates. Cancel or reschedule up to
                24 hours before, no charge.
              </p>
            </div>
            <Link href={BRAND.booking.primaryPath}>
      ...
      <section className="py-20 sm:py-32">
        <div className="container">
          ...
          >
            ...
            <motion.div
              variants={fadeUp}
              className="divide-y divide-border/60 rounded-2xl border border-border bg-card px-6"
            >
              {faqs.map(faq => (
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-display font-bold text-lg">
                  We Come to You — All of SE Wisconsin
                </h3>
                <p className="text-muted-foreground text-sm mt-1 max-w-md">
                  Racine County, Kenosha County, and the greater Milwaukee
                  metro. Enter your address at booking to confirm we can reach
                  you.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 sm:py-32 relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          >
            <motion.h2
              variants={fadeUp}
              className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold mb-5"
            >
              Your car is sitting in the
              <br />
              driveway right now.
            </motion.h2>
            <motion.p
            ...
            >
              Same-week availability on most dates. Book in under two minutes —
              no credit card required.
            </motion.p>
            <motion.div
              variants={fadeUp}
              className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 px-4 sm:px-0"
            >
              <Link href={BRAND.booking.primaryPath}>
                <Button
                  size="lg"
              ...
              <a href={phoneHref}>
                <Button
                  size="lg"
                  variant="outline"
                  className="border-border hover:border-primary/60 font-semibold px-10 h-14 text-lg w-full sm:w-auto"
                >
