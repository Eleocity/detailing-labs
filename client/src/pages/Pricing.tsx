...
const FALLBACK_PACKAGES = CENTRAL_PACKAGES.filter(
...
const FALLBACK_ADDONS = CENTRAL_ADDONS.filter(a => a.isActive).map(a => ({
  name: a.name,
...
const PACKAGE_META: Record<string, { bestFor: string }> = Object.fromEntries(
  CENTRAL_PACKAGES.map(p => [p.name, { bestFor: p.recommendedFor }])
);
      ...
      <section className="pt-24 pb-10 sm:pt-28 sm:pb-16 bg-[#0a0a0a] relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            >
              No hidden fees. No surprises. Choose your service type below to
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Interior, exterior, and full-detail packages with
                    transparent, upfront pricing. Book online instantly.
                  </p>
                </div>
                <div
                  className={cn(
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Long-term paint protection tailored to your vehicle. Every
                    coating is custom-quoted based on size and condition.
                  </p>
                </div>
                <div
                  className={cn(
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    tab === "fleet"
                      ? "bg-sky-500/20"
                      : "bg-muted group-hover:bg-sky-500/10"
                  )}
                >
                  <Zap
                    className={cn(
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Multiple vehicles? We offer fleet programs for businesses,
                    dealerships, and property managers. Custom pricing and
                    scheduling.
                  </p>
                </div>
                <div
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    tab === "paint"
                      ? "bg-rose-500/20"
                      : "bg-muted group-hover:bg-rose-500/10"
                  )}
                >
                  <Wrench
                    className={cn(
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Remove swirl marks, scratches, and oxidation. Every
                    correction is quoted based on your paint's condition and
                  ...
                  {!vehicleSizeSelected ? (
                    <div className="flex flex-col items-center justify-center py-16 text-center">
                      ...
                      <p className="font-display font-bold text-lg mb-2">
                        Select your vehicle size above
                      </p>
                      <p className="text-muted-foreground text-sm max-w-xs">
                        We want to make sure you see the right price for your
                        vehicle before you book.
                      </p>
                    </div>
                  ) : (
                    <>
                                ...
                                {VEHICLE_TIERS[pkg.name] ? (
                                  <div className="flex items-end gap-2">
                                    ...
                                    <span className="text-muted-foreground text-sm mb-1.5">
                                      {vehicleSize
                                        ? VEHICLE_SIZE_LABELS[vehicleSize]
                                        : ""}
                                    </span>
                                  </div>
                                ) : (
                      ...
                      <div className="rounded-2xl border border-border bg-[#0a0a0a] p-8 mb-8">
                        <div className="text-center mb-8">
                          ...
                          <p className="text-muted-foreground mt-2 text-sm">
                            Select any of these during booking to enhance your
                            package.
                          </p>
                        </div>
                          ...
                          {addOns.map(addon => (
                            ...
                            >
                              <div className="text-xl font-display font-bold text-primary mb-1">
                                {(addon as any).description?.includes("–")
                                  ? (addon as any).description?.split(
                                      " "
                                    )?.[0] + "+"
                      ...
                      <div className="space-y-3">
                        <div className="flex gap-3 p-4 rounded-xl border border-border bg-card">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground text-sm">
                              All services are performed at your location. A
                              travel fee may apply outside our primary service
                              area.
                            </p>
                          </div>
                        </div>
                        <div className="flex gap-3 p-4 rounded-xl border border-border bg-card">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground text-sm">
                              Prices shown are for the selected vehicle size.
                        ...
                        <div className="flex gap-3 p-4 rounded-xl border border-primary/20 bg-primary/5">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground text-sm">
                              If you're not happy with the result, tell us and
                              we'll come back and make it right — no charge. We
              ...
              {tab === "ceramic" && (
                ...
                >
                  ...
                  <div className="rounded-2xl border border-amber-500/25 bg-amber-500/5 p-8 mb-6 text-center">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-amber-500/15 border border-amber-500/30 mb-3">
                      <span className="text-amber-400 font-bold text-sm">
                        Every coating is custom-quoted based on your paint's
                        condition
                      </span>
                    </div>
                    <p className="text-muted-foreground text-sm">
                      We'll assess your vehicle, walk you through exactly what's
                      needed, and give you a transparent quote with no pressure.
                    </p>
                  </div>
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-muted-foreground text-xs">
                            Fastest way to get a quote — we typically respond
                            within minutes
                          </p>
                        </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-muted-foreground text-xs">
                            Send us your vehicle details and we'll prepare a
                            full quote
                          </p>
                        </div>
                        <ChevronRight className="w-4 h-4 text-muted-foreground group-hover:text-primary transition-colors flex-shrink-0" />
                      ...
                      <Link href="/contact">
                        <div className="flex items-center gap-4 p-4 rounded-xl border-2 border-border hover:border-primary/40 hover:bg-muted/30 transition-all group cursor-pointer">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-muted-foreground text-xs">
                              Fill out our contact form and we'll follow up with
                              a quote
                            </p>
                          </div>
                          <ChevronRight className="w-4 h-4 text-muted-foreground group-hover:text-primary transition-colors flex-shrink-0" />
                  ...
                  <p className="text-center text-xs text-muted-foreground">
                    Not ready for ceramic?{" "}
                    <button
                      onClick={() => setTab("detailing")}
                      className="text-primary hover:underline font-medium"
                    >
                      View our detailing packages instead →
                    </button>
                  </p>
                </motion.div>
              )}
              ...
              {tab === "fleet" && (
                ...
                >
                  <div className="rounded-2xl border border-sky-500/25 bg-sky-500/5 p-8 mb-6 text-center">
                    ...
                    <h2 className="text-2xl font-display font-bold mb-3">
                      Fleet & Business Programs
                    </h2>
                    <p className="text-muted-foreground leading-relaxed mb-2">
                      We work with businesses, dealerships, property managers,
                      and anyone running multiple vehicles. Fleet pricing is
                  ...
                  <div className="rounded-2xl border border-border bg-card p-6 mb-4">
                    ...
                    <p className="text-muted-foreground text-sm mb-5">
                      Tell us about your fleet and we'll get back to you with a
                      program that fits.
                    </p>
                    <div className="flex flex-col gap-3">
                      <a
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-muted-foreground text-xs">
                            Call or text — we'll discuss your fleet needs
                            directly
                          </p>
                        </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-muted-foreground text-xs">
                            Send us your vehicle count and we'll build a quote
                          </p>
                        </div>
                        <ChevronRight className="w-4 h-4 text-muted-foreground group-hover:text-sky-500 transition-colors flex-shrink-0" />
                      </a>
                      <Link href="/contact">
                        <div className="flex items-center gap-4 p-4 rounded-xl border-2 border-border hover:border-sky-500/40 hover:bg-muted/30 transition-all group cursor-pointer">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-muted-foreground text-xs">
                              Fill out our contact form with your fleet details
                            </p>
                          </div>
                          <ChevronRight className="w-4 h-4 text-muted-foreground group-hover:text-sky-500 transition-colors flex-shrink-0" />
                        </div>
              ...
              {tab === "paint" && (
                ...
                >
                  <div className="rounded-2xl border border-rose-500/25 bg-rose-500/5 p-8 mb-6 text-center">
                    ...
                    <h2 className="text-2xl font-display font-bold mb-3">
                      Paint Correction is Custom Work
                    </h2>
                    <p className="text-muted-foreground leading-relaxed mb-2">
                      Every vehicle's paint is different. The level of
                      correction needed depends on the severity of swirl marks,
                      scratches, and oxidation — and how refined a finish you
                      want as the end result.
                    </p>
                    <p className="text-muted-foreground text-sm">
                      We inspect the paint, walk you through what's achievable,
                      and quote based on what's actually needed. No guessing, no
                      surprises.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-border bg-card p-6 mb-4">
                    <h3 className="font-display font-bold mb-1">
                      Get Your Paint Correction Quote
                    </h3>
                    <p className="text-muted-foreground text-sm mb-5">
                      Send us a few photos of your paint or reach out directly —
                      we'll give you a straight assessment.
                    </p>
                    <div className="flex flex-col gap-3">
                      <a
                        href={phoneHref}
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-muted-foreground text-xs">
                            Call or text — we can assess from photos too
                          </p>
                        </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-muted-foreground text-xs">
                            Email us with photos for a remote assessment
                          </p>
                        </div>
                        <ChevronRight className="w-4 h-4 text-muted-foreground group-hover:text-rose-400 transition-colors flex-shrink-0" />
                      </a>
                      <Link href="/contact">
                        <div className="flex items-center gap-4 p-4 rounded-xl border-2 border-border hover:border-rose-500/40 hover:bg-muted/30 transition-all group cursor-pointer">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-muted-foreground text-xs">
                              Describe your paint issues and we'll follow up
                              with a quote
                            </p>
                          </div>
                          <ChevronRight className="w-4 h-4 text-muted-foreground group-hover:text-rose-400 transition-colors flex-shrink-0" />
                  ...
                  <p className="text-center text-xs text-muted-foreground">
                    Interested in ceramic coating after correction?{" "}
                    <button
                      onClick={() => setTab("ceramic")}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 px-4 sm:px-0">
              {tab === "detailing" ? (
                ...
                <>
                  <button
                    onClick={() => setTab("detailing")}
                    className="w-full sm:w-auto px-8 h-12 rounded-xl border-2 border-primary text-primary font-semibold text-sm sm:text-base hover:bg-primary hover:text-primary-foreground transition-colors"
                  >
                    View Detailing Packages
                  </button>
                  <button
                    onClick={() => setTab("ceramic")}
                    className="w-full sm:w-auto px-8 h-12 rounded-xl border-2 border-amber-500/50 text-amber-500 font-semibold text-sm sm:text-base hover:bg-amber-500/10 transition-colors"
                  >
                    Get Ceramic Quote
                  </button>
                </>
