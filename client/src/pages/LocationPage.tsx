...
export const LOCATIONS: LocationData[] = [
  ...
  },
  {
    ...
    subheadline:
      "Forma Auto Spa is based in Sturtevant. Professional mobile detailing at your door — same-week availability.",
    bodyParagraph:
      "Our home base is Sturtevant, WI, which means fast response times and same-week availability for most customers in the area. We service vehicles at your home, workplace, or any accessible location. Full interior, exterior, and ceramic coating services available.",
    nearbyTowns: [
      "Racine",
      "Mount Pleasant",
      "Caledonia",
  ...
  },
  {
    ...
    subheadline:
      "Forma Auto Spa serves Burlington and western Racine County with professional mobile detailing.",
    bodyParagraph:
      "We extend our mobile detailing service west into Burlington and the surrounding areas of western Racine County. Travel fees may apply for locations further from our Sturtevant base — we'll confirm at booking. Same professional setup, same quality of work.",
    nearbyTowns: [
      "Rochester",
      "Union Grove",
      "Waterford",
...
function LocationPage({ location }: { location: LocationData }) {
  ...
  const jsonLd = [
    {
      ...localBusinessSchema,
      name: `Forma Auto Spa — ${fullLocation}`,
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SiteHeader />
      <SEO
        title={`${location.headline} | Forma Auto Spa`}
            ...
            >
              ...
              <a href={phoneHref}>
                <Button
                  size="lg"
                  variant="outline"
                  className="border-border hover:border-primary/50 font-semibold px-8 h-12 w-full sm:w-auto"
                >
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start max-w-5xl mx-auto">
            <div>
              ...
              {location.landmarks && (
                <p className="text-muted-foreground leading-relaxed mb-6">
                  We operate throughout {location.city} — {location.landmarks} —
                  and can service your vehicle at your home, workplace, or any
                  accessible location.
                </p>
              )}
            ...
            <div className="space-y-4">
              ...
              <div className="p-6 rounded-2xl border-2 border-primary/40 bg-primary/5">
                ...
                <Link href="/pricing">
                  <Button
                    variant="outline"
                    className="w-full border-border hover:border-primary/50 text-sm"
                  >
              ...
              <div className="group flex flex-col gap-4 p-6 rounded-2xl border-2 border-border bg-card hover:border-primary/60 hover:bg-primary/4 transition-all cursor-pointer h-full">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Interior, exterior, and full-service from $129.
                  </p>
                </div>
            ...
            <Link href="/pricing?tab=ceramic">
              <div className="group flex flex-col gap-4 p-6 rounded-2xl border-2 border-border bg-card hover:border-amber-500/50 hover:bg-amber-500/3 transition-all cursor-pointer h-full">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Custom-quoted to your vehicle. Long-term protection.
                  </p>
                </div>
      ...
      <section className="py-12 sm:py-16">
        <div className="container max-w-3xl mx-auto">
          <h2 className="text-xl font-display font-bold mb-5">
            Also Serving Near {location.city}
          </h2>
          <div className="flex flex-wrap gap-2">
            {location.nearbyTowns.map(town => (
              <span
                key={town}
                className="text-sm px-3.5 py-1.5 rounded-full border border-border bg-card text-muted-foreground hover:border-primary/40 hover:text-foreground transition-colors"
              >
                {town}, WI
              </span>
            ))}
          ...
          <p className="text-muted-foreground text-sm mt-5 leading-relaxed">
            We service {location.city} and surrounding {location.county}{" "}
            communities. If your town isn't listed,{" "}
            <Link href="/contact">
      ...
      <section className="py-14 bg-[#0a0a0a]">
        <div className="container text-center">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto mb-8 text-sm">
            Book online, we confirm, and we show up at your location — fully
...
export function LocationPageRacine() {
  return <LocationPage location={LOCATIONS[0]} />;
}
export function LocationPageKenosha() {
  return <LocationPage location={LOCATIONS[1]} />;
}
export function LocationPageSturtevant() {
  return <LocationPage location={LOCATIONS[2]} />;
}
export function LocationPageMountPleasant() {
  return <LocationPage location={LOCATIONS[3]} />;
}
export function LocationPageOakCreek() {
  return <LocationPage location={LOCATIONS[4]} />;
}
export function LocationPageCaledonia() {
  return <LocationPage location={LOCATIONS[5]} />;
}
export function LocationPageBurlington() {
  return <LocationPage location={LOCATIONS[6]} />;
}
export function LocationPageFranksville() {
  return <LocationPage location={LOCATIONS[7]} />;
}
