...
export default function InvoiceDetail() {
  ...
  const lineItems: { name: string; qty: number; price: number }[] = invoice!
    .lineItems
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              <span
                className={`text-xs px-2 py-1 rounded-full border font-medium ${STATUS_COLORS[invoice!.status ?? "draft"] ?? ""}`}
              >
                {invoice!.status}
              </span>
              <Button
          ...
          <div className="rounded-2xl border border-border bg-card p-8 print:border-none print:shadow-none">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-center pb-3 font-medium text-muted-foreground w-16">
                      Qty
                    </th>
                    <th className="text-right pb-3 font-medium text-muted-foreground w-24">
                      Price
                    </th>
                    <th className="text-right pb-3 font-medium text-muted-foreground w-24">
                      Total
            ...
            <div className="mt-8 pt-4 border-t border-border text-center text-xs text-muted-foreground">
              Thank you for choosing Forma Auto Spa — Premium Mobile Auto
              Detailing
            </div>
          </div>
        </div>
