...
export default function Contact() {
  ...
  const contact = (() => {
    ...
    if (contactContent)
      for (const row of contactContent) map[row.key] = row.value ?? "";
    return map;
  })();
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SiteHeader />
      <SEO
        title="Contact Forma Auto Spa — Racine County, WI"
        description="Contact Forma Auto Spa — professional mobile detailing in Southeast Wisconsin. Call, text, or message us. We serve Racine County, Kenosha, and surrounding areas."
        canonical="/contact"
      ...
      <section className="pt-24 pb-10 sm:pt-28 sm:pb-16 bg-[#0a0a0a]">
        <div className="container text-center">
          ...
          >
            ...
            >
              Have a question or want to discuss a custom detail? We'd love to
              hear from you.
            </motion.p>
          </motion.div>
        </div>
                ...
                {[
                  {
                    ...
                    href: `tel:${(contact.phone || BRAND.phone).replace(/\D/g, "")}`,
                  },
                  {
                    icon: <Mail className="w-5 h-5" />,
                    label: "Email",
                    value: contact.email || BRAND.emailLive,
                    href: `mailto:${contact.email || BRAND.emailLive}`,
                  },
                  {
                    icon: <MapPin className="w-5 h-5" />,
                    label: "Service Area",
                    value:
                      contact.address || BRAND.serviceArea.primaryRegionLabel,
                    href: null,
                  },
                  {
