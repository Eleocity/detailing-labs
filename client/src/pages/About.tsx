...
const values = [
  ...
  },
  {
    ...
    desc: "We use the same products professionals trust on high-end vehicles. Not whatever's cheapest.",
  },
  {
    icon: <Star className="w-5 h-5" />,
    title: "No Shortcuts",
    desc: "We don't rush jobs. Every vehicle gets the same level of care regardless of size or service level.",
  },
  {
    icon: <MapPin className="w-5 h-5" />,
    title: "Local and Committed",
    desc: "We're based in Sturtevant and focused on Southeast Wisconsin. This is our home market — we're building a reputation here.",
  },
  {
    icon: <Sparkles className="w-5 h-5" />,
    title: "Honest Pricing",
    desc: "What you see on the pricing page is what you pay. We quote before we start, and we don't add surprise charges.",
  },
];
...
export default function About() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SiteHeader />
      <SEO
        title="About Forma Auto Spa — Mobile Detailing in Southeast Wisconsin"
        description="Forma Auto Spa is a mobile detailing company based in Sturtevant, WI serving Racine County and surrounding areas. Learn about who we are and how we work."
        canonical="/about"
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              >
                We started Forma Auto Spa because getting a truly professional
                detail in Southeast Wisconsin shouldn't require a trip to a
                shop, a half-day of waiting, and hoping they do good work. We
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start max-w-5xl mx-auto">
            ...
            >
              ...
              >
                <p>
                  The idea behind Forma Auto Spa is straightforward. Too many
                  mobile detailers show up with a bucket and a pressure washer
                  and call it professional. Too many shops rush through jobs and
                  charge accordingly. We wanted to offer something different — a
                  proper, professional-grade detail that comes to you.
                </p>
                <p>
                ...
                <p>
                  ...
                  franchise. We're not a side gig. This is our business and our
                  reputation is built one vehicle at a time.
                </p>
              </motion.div>
              ...
              >
                ...
                <Link href="/contact">
                  <Button
                    variant="outline"
                    className="border-border hover:border-primary/50 px-7 w-full sm:w-auto"
                  >
                    Get In Touch
                  </Button>
                </Link>
            ...
            {[
              {
                step: "1",
                title: "Book online",
                desc: "Choose your package, enter your address, and pick a date. Takes under two minutes.",
              },
              {
                step: "2",
                title: "We confirm",
                desc: "You'll get a booking confirmation by email with your appointment details and our contact number.",
              },
              {
                step: "3",
                title: "We show up",
              ...
              },
              {
                step: "4",
                title: "We deliver",
                desc: "We complete the service and you inspect the work. Payment is collected on-site when you're satisfied.",
              },
            ].map(item => (
              <div
                key={item.step}
