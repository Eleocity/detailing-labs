...
const pkg = getPackageByKey("paint-correction")!;
...
export default function PaintCorrection() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SiteHeader />
      <SEO
        title="Paint Correction — Racine & Kenosha County, WI"
        description={`Professional paint correction in ${BRAND.serviceArea.primaryRegionLabel}. Swirl marks, light scratches, and oxidation removed by hand and machine, quoted to your paint's actual condition.`}
        canonical="/paint-correction"
        jsonLd={[
          serviceSchema("Paint Correction", pkg.fullDescription),
          breadcrumbSchema([
            { name: "Home", url: "/" },
          ...
          >
            ...
            >
              <h3 className="font-display font-bold text-lg mb-2">
                Every correction is custom work
              </h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                The level of correction needed depends on the severity of swirl
                marks, scratches, and oxidation — and how refined a finish
                you're after. We inspect the paint, explain what's realistically
                achievable, and quote based on what's actually needed.
              </p>
            </motion.div>
            ...
            >
              <h3 className="font-display font-bold text-lg mb-1">
                Protect the result with ceramic coating
              </h3>
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                Once corrected, a ceramic coating locks in the finish and makes
                it dramatically easier to keep that way.
              </p>
              <Link href="/ceramic-coatings">
                <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-primary hover:underline cursor-pointer">
                  See Ceramic Coatings <ChevronRight className="w-4 h-4" />
                </span>
              </Link>
            </motion.div>
          </motion.div>
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center p-8 rounded-2xl border border-border bg-card">
            ...
            <p className="text-muted-foreground text-sm mb-6">
              Send a few photos or reach out directly — we'll give you a
              straight assessment.
            </p>
