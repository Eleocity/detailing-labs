...
function loadMapScript() {
  return new Promise(resolve => {
    if (!API_KEY) {
      console.warn("[Map] No Google Maps API key — add VITE_GOOGLE_MAPS_API_KEY to Railway variables.");
      resolve(null);
      return;
    }
    ...
    script.onerror = () => console.error("[Map] Failed to load Google Maps — check VITE_GOOGLE_MAPS_API_KEY");
