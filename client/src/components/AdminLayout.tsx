...
const menuItems = [
  ...
  { icon: LayoutGrid, label: "Schedule Board", path: "/admin/schedule-board" },
  ...
  { icon: MapPin, label: "Service Areas", path: "/admin/service-areas" },
      ...
      <SidebarInset>
        {isMobile && (
          <div className="flex border-b h-14 items-center justify-between bg-background/95 px-3 backdrop-blur sticky top-0 z-40">
            ...
            <a href={BRAND.booking.primaryPath}>
              <button className="h-8 px-3 rounded-lg bg-primary text-primary-foreground text-xs font-semibold">
                + Book
              </button>
            </a>
          </div>
